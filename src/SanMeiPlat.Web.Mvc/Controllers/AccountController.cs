...
using SanMeiPlat.Sessions;
using SanMeiPlat.Web.Models.Account;
using SanMeiPlat.Web.Views.Shared.Components.TenantChange;

namespace SanMeiPlat.Web.Controllers
{
    public class AccountController : SanMeiPlatControllerBase
    {
