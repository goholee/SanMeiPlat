...
namespace SanMeiPlat.Migrations
{
    ...
    partial class Added_Description_And_IsActive_To_Role
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SanMeiPlat.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SanMeiPlat.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SanMeiPlat.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SanMeiPlat.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SanMeiPlat.Authorization.Roles.Role", b =>
                {
                    b.HasOne("SanMeiPlat.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("SanMeiPlat.Authorization.Users.User", "DeleterUser")
                        .WithMany()
